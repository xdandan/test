        ...
        listeners:{
                edit:function(editor,e,opts){
                            ...
                            Ext.Ajax.request({  
                                ...
                                params: {  
                                    orderId:formData.id,
                                    qcAdress:formData.qcAdress,
                                    qcUser:formData.qcUser,
                                 ...
                                 if(result.success){
                                   if(result.msg==1){
				                            Ext.MessageBox.alert('错误', '供应商未填写订单进度!');
				                      }else{
        ...
        {  text: 'QC 检验',   locked   : true,
                ...
                {text     : '检验地',width    : 75,locked   : true,  sortable : true,  dataIndex: 'qcAdress',
                 editor: new Ext.form.field.ComboBox({
                    ...
                    triggerAction: 'all',
                    selectOnTab: true,
                    store: selectAdressData,
                    lazyRender: true,
                    listClass: 'x-combo-list-small'
                })}, 
                { text     : '品质标准',width    : 75,locked   : true,sortable : true,dataIndex: 'change'}, 
                { text     : '检验员',width    : 80,locked   : true,dataIndex: 'qcUser', editor: {xtype: 'textfield'}},
                ...
                { text     : '检验结果',width    : 80,locked   : true,dataIndex: 'check_result',
                 editor: new Ext.form.field.ComboBox({
                    ...
                    triggerAction: 'all',
                    selectOnTab: true,
                    store: selectResultData,
                    lazyRender: true,
                    listClass: 'x-combo-list-small'
                })},
                { text     : '问题点代码',width    : 90,locked   : true,dataIndex: 'question',editor: {xtype: 'textfield'}},
                ...
                },dataIndex: 'pass', editor: {xtype: 'numberfield' }},
                  { text     : '检验日期',width    : 80,locked   : true, renderer : Ext.util.Format.dateRenderer('Y-m-d'),dataIndex: 'checkDate',
                     editor: {xtype: 'datefield'}}
                ]
           },
        {text     : '供应商整改意见',width    : 120,sortable : true,locked   : true,dataIndex: 'qcRemark'},
