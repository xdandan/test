...
var rowEditing = Ext.create('Ext.grid.plugin.RowEditing', {
    ...
    {  xtype: 'rownumberer',locked   : true, text: '序号',align : 'center', width: 60},
        {text     : '供应商跟单批注',width    : 140,sortable : true,locked   : true,dataIndex: 'supplyComment'},
        {text     : '朗盛光学跟单批注',width    : 150,sortable : true,locked   : true,dataIndex: 'ourComment',editor: {xtype: 'textfield'}},
